...
describe("messaging", () => {
  ...
  it("quicksms with sharednumber", () => {
    ...
    cy.xpath("//textarea[@placeholder='Type a message']").type(
      " sharednumber testing "
    );
    Tag += "\n"
    let SenderID = "shared number";
    allure.step(`sender ID = ${SenderID}`, () => {});
    Tag += "textarea message = sharednumber testing "
    Tag += "\n"
    let TextAreaMessage = "sharednumber testing";
    allure.step(`text area message = ${TextAreaMessage}`, () => {});
